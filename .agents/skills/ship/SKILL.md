...
- Read `AGENTS.md` sections relevant to the changed files
...
- Review for correctness, quality, and consistency with AGENTS.md conventions (Conventional Commits, TypeScript strict, ESM module format)
